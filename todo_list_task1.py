...
def main():
    ...
    while True:
        ...
        if choice == '1':
            ...
            todo_list.add_work(activity) # add_task() is a method to add task into the TodoList
        elif choice == '2':
            activity = input("Enter the task to remove from the To-Do List: ")
            todo_list.rem_work(activity) #rem_task() is a method to remove task from the TodoList
        elif choice == '3':
            todo_list.disp_work() #disp_tasks() is a method to display tasks from the TodoList
        elif choice == '4':
